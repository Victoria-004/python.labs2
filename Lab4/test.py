...
class TestHeapBasedPriorityQueue(unittest.TestCase):
    def setUp(self):
        self.pq = HeapBasedPriorityQueue()
    ...
    def test_push_and_peek(self):
        ...
        self.pq.push('f', 6)
        self.pq.push('hi', 0)
        self.assertEqual(self.pq.peek(), 'hi')
    ...
    def test_pop(self):
        ...
        self.pq.push('d', 2)
        self.pq.push('hi', 0)
        self.assertEqual(self.pq.pop(), 'hi')
        self.assertEqual(self.pq.pop(), 'n')
        self.assertEqual(self.pq.pop(), 'd')
